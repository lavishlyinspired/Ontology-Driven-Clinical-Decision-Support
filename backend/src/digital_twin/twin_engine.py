...
class DigitalTwinEngine:
    ...
    async def initialize(self, patient_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        """
        logger.info(f"🚀 Initializing digital twin for {self.patient_id}")
        ...
        if self.graph_db.is_available:
            try:
                ...
                logger.info("✓ Patient data persisted to Neo4j")
        ...
        logger.info(f"✅ Digital twin initialized successfully: {self.twin_id}")
    ...
    async def update(self, update_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        """
        logger.info(f"🔄 Updating digital twin: {update_data.get('type')}")
        ...
        logger.info(f"✅ Twin updated: {len(new_alerts)} new alerts, {len(affected_agents)} agents re-run")
    ...
    async def predict_trajectories(self) -> Dict[str, Any]:
        ...
        """
        logger.info(f"🔮 Predicting trajectories for {self.patient_id}")
...
async def demo_digital_twin():
    ...
    print(f"✅ Twin initialized: {init_result['twin_id']}")
    print(f"   Context graph: {init_result['context_graph_nodes']} nodes\n")
    
    # Simulate lab result update
    print("🔬 New lab result: T790M resistance mutation detected\n")
    ...
    print(f"💾 Twin exported: {len(export['context_graph']['nodes'])} nodes in graph\n")
